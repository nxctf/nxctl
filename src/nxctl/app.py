...
Examples:
  ...
  nxctl ps                        Show tunnel provider processes
    ...
    list_cmd.add_argument("-a", "--all", action="store_true", help="Show effective challenge config")
    list_cmd.add_argument("-k", "--key", action="store_true", help="Show challenge key values from nxctl.yml")
