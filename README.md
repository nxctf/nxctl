...
| `nxctl up --all [prefix]` | Start enabled challenges at or below an optional path prefix | `nxctl up --all NFCTF/lab-01` |
...
| `/up?all=true&prefix=...` | POST | Start enabled challenges under an optional path prefix |
