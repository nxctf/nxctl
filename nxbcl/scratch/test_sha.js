...
function sha256Pure(str) {
  ...
  for (let i = 0; i < words.length; i += 16) {
    ...
    // Ensure array is padded to 16/64 words
...
const testVal = "hello_world_12345";
const pure = sha256Pure(testVal);
const real = crypto.createHash('sha256').update(testVal).digest('hex');

console.log("Pure:", pure);
console.log("Real:", real);
console.log("Match:", pure === real);
